...
namespace Microsoft.Kiota.Abstractions.Serialization
{
    ...
    public class ParseNodeFactoryRegistry : IParseNodeFactory
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var (factory, correctContentType) = GetFactory(contentType);

            return await factory.GetRootParseNodeAsync(correctContentType, content, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get the <see cref="IParseNodeFactory"/> instance for the given <paramref name="contentType"/>.
        /// </summary>
        /// <param name="contentType">The content type of the stream</param>
        /// <returns></returns>
        /// <exception cref="InvalidOperationException"></exception>
        public (IParseNodeFactory Factory, string ContentType) GetFactory(string contentType)
        {
            ...
            return (factory, resultContentType);
        }
    }
}
