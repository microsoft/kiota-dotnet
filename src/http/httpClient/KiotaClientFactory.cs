...
namespace Microsoft.Kiota.Http.HttpClientLibrary
{
    ...
    public static class KiotaClientFactory
    {
        ...
        public static HttpMessageHandler GetDefaultHttpMessageHandler(IWebProxy? proxy = null)
        {
            ...
            return new WinHttpHandler { Proxy = proxy, AutomaticDecompression = DecompressionMethods.All, WindowsProxyUsePolicy = proxyPolicy, SendTimeout = System.Threading.Timeout.InfiniteTimeSpan, ReceiveDataTimeout = System.Threading.Timeout.InfiniteTimeSpan, ReceiveHeadersTimeout = System.Threading.Timeout.InfiniteTimeSpan, EnableMultipleHttp2Connections = true };
...
#else
            return new HttpClientHandler { Proxy = proxy, AllowAutoRedirect = false, AutomaticDecompression = DecompressionMethods.All };
#endif
        }
    }
}
